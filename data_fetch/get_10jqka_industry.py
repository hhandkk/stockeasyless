...
def get_10jqka_industry():
    ...
    url=config.getConfig()["url"]["quote_10jqka_industry"]
    print(url)
    print(headers)
    ...
    utils.clean_10jqka_industry()
    for i in result_list:
        utils.save_10jqka_industry(i)
    print( "热点行业数据已经入库，共计" + str(len(result_list)) +"条数据。")
